...
public class BankingSystem {
    public static void main(String[] args) {
        ...
        performTransaction(bobAccount, "Bob", TransactionType.DEPOSIT, 2000);
        performTransaction(bobAccount, "Bob", TransactionType.WITHDRAW, 500);
        performTransaction(bobAccount, "Bob", TransactionType.DEPOSIT, 1000);
        performTransaction(bobAccount, "Bob", TransactionType.WITHDRAW, 3000);
        performTransaction(bobAccount, "Bob", TransactionType.WITHDRAW, 2000);

        // Perform transactions for Alice
        performTransaction(aliceAccount, "Alice", TransactionType.DEPOSIT, 5000);
        performTransaction(aliceAccount, "Alice", TransactionType.WITHDRAW, 600);
        performTransaction(aliceAccount, "Alice", TransactionType.DEPOSIT, 1500);
        performTransaction(aliceAccount, "Alice", TransactionType.WITHDRAW, 2500);
    ...
    private static void performTransaction(Account account, String name, TransactionType type, double amount) {
